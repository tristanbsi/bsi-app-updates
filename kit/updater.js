...
//
// The same file is copied into each app (PatchMap code/updater.js, StandBy host/lib/updater.js, Loader lib/updater.js).
// The source of truth is bsi-app-updates/kit/updater.js; `node tools/sync-kit.js` copies it out.
'use strict';
...
// appId: 'patchmap' | 'standby' | 'loader'. currentVersion: the code running now. shellVersion: the installed app itself.
